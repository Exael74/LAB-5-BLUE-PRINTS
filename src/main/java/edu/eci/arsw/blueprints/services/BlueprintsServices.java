...
public class BlueprintsServices {
    ...
    /** Total de puntos acumulados por un autor (útil para el panel del Front). */
    public int totalPointsByAuthor(String author) throws BlueprintNotFoundException {
        return getBlueprintsByAuthor(author).stream()
